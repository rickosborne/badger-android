package org.rickosborne.badger.util;

/**
 * This code is from Jules White's `SecuredRestBuilder` class
 * from the Coursera Android specialization course material.
 */
 ...
 *
 private WhateverSvcApi whateverService = new SecuredRestBuilder()
 .setLoginEndpoint(TEST_URL + WhateverSvcApi.TOKEN_PATH)
 .setUsername(USERNAME)
 .setPassword(PASSWORD)
 .setClientId(CLIENT_ID)
 .setClient(new ApacheClient(UnsafeHttpsClient.createUnsafeClient()))
 .setEndpoint(TEST_URL).setLogLevel(LogLevel.FULL).build()
 .create(WhateverSvcApi.class);
 *
