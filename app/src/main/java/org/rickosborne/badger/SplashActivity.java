...
import org.rickosborne.badger.util.SystemUiHider;
...
public class SplashActivity extends Activity {
     ...
     */
    private static final int AUTO_HIDE_DELAY_MILLIS = 750;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        svgImageView.setImageResource(R.drawable.badger);
        svgImageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
        final LinearLayout layout = (LinearLayout) findViewById(R.id.splashContainer);
        layout.addView(svgImageView, 0);  // new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT));
