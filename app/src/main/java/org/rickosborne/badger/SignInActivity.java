...
import org.rickosborne.badger.util.SecuredRestException;
...
public class SignInActivity extends Activity implements LoaderCallbacks<Cursor>{
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        private boolean hasPatients = false;
        ...
        protected Boolean doInBackground(Void... params) {
            final BadgerApp app = (BadgerApp) getApplication();
            User me = app.getUser(mEmail, mPassword);
    ...
    public void signInPatient(View v) {
        startActivity(new Intent(this, PatientHomeActivity.class));
        finish();
    }
    public void signInDoctor(View v) {
